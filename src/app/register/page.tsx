...
import { registerUser } from '../lib/action/registerUser';
	...
	return (
		<section className="text-gray-600 body-font">
			<div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
				...
				>
					<h2 className="text-gray-900 text-lg font-medium title-font mb-5">登録</h2>
					...
					<div className="flex justify-around flex-row text-center">
						...
						<button className="ml-2 w-screen text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
							登録
						</button>
					</div>
